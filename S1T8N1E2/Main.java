...
public class Main {
	...
	public static void buscaLletra(ArrayList<String> plantilla) {
		...
		System.out.println("Jugadors amb la lletra O: " + agafaO);
	...
	public static void buscaCincLletres(ArrayList<String> plantilla) {
		
		List<String> agafaCinc = plantilla.stream().filter(paraula -> paraula.length() > 5).collect(Collectors.toList());
		System.out.println("Jugadors amb 5 lletres: " + agafaCinc);
		
		//.lenght per la llargaria de la paraula (paraula.length() > 5) que tingui 5 o més
	}
	...
	public static void main(String[] args) {
		...
		Main.buscaCincLletres(plantilla);
